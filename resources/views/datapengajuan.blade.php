...
<head>
  ...
  <title>Data Pengajuan : LAYAR</title>
...
<li class="nav-item">
    <a class="nav-link" href="{{ route('datapengajuan') }}">
...
@endif
          ...
          <div class="card">
            <div class="card-body pt-3">
                <div class="tab-pane fade show active datapenduduk-kk1" id="datapenduduk-kk1">
                  <h5 class="card-title">List Pengajuan</h5>
                              ...
                              <table id="example1" class="table table-bordered table-striped">
                                <thead class="table-white align-items-center">
                                  ...
                                  <tr>
                                    ...
                                    <th width="300px" scope="col">Tipe Surat</th>
                                    <th width="200px" scope="col">Nama Pengaju</th>
                                    <th width="250px" scope="col">Tanggal Pembuatan</th>
  ...
  @endphp
                                  ...
                                  <tr>
                                    ...
                                    <a href="/tampilkansuratpengajuan/{{ $row -> id}}" type="button" class="btn btn-primary">Lihat Surat Pengajuan</button></a>
