            ...
            <div class="card">
              ...
              <form class="row g-3">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Nama Agenda" id="inputNama5" name="nama_agenda" required>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Lokasi Agenda" id="inputnokk5s" name="lokasi" required>
                </div>
