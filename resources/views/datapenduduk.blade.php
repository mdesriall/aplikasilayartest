...
<li class="nav-item">
  ...
  @endphp
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <div class="text-start">
                                    <a href="/tampilkandata/{{ $row -> id}}" type="button" class="btn btn-primary">Edit</button></a>
                                    <a href="#" type="button" class="btn btn-secondary delete" data-id="{{ $row -> id}} data-nama="{{ $row -> nama_lengkap}}">Hapus</button></a>
                                    </div>
...
<script>
  $('.delete').click(function () {
    var datapenduduksid = $(this).attr('data-id');
    var namalengkap = $(this).attr('data-namalengkap'); // Update attribute name here

    Swal.fire({
      title: 'Apakah Anda Yakin?',
      text: "Anda Akan Menghapus Data Ini: " + namalengkap + " ",
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        window.location = "/delete/" + datapenduduksid + "";
