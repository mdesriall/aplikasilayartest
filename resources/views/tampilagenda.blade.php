            ...
            <div class="card">
              ...
              <form class="row g-3">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Nama Agenda" id="inputNama5" name="nama_agenda" value="{{ $data -> nama_agenda}}">
                </div>
                <div class="col-md-12">
                <label for="inputtgllahir" class="form-label">Tanggal Agenda</label>
                <div class="col-sm-12">
                <input type="date" class="form-control" name="tgl_kegiatan" required value="{{ $data -> tgl_kegiatan}}">
                </div>
                </div>
                <div class="col-md-12">
                  <label for="inputnokk5" class="form-label">Lokasi</label>
                  <input type="text" class="form-control" placeholder="Masukkan Lokasi Agenda" id="inputnokk5s" name="lokasi" value="{{ $data -> lokasi}}">
                </div>
                <div class="col-md-12">
                ...
                <div class="text-end">
                <!-- Basic Modal -->
                <button type="button" class="btn btn-pengajuan update" data-id="{{ $data->id }}" data-nama="{{ $data->nama_agenda }}">Tambah Data</button>
