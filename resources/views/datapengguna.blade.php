...
<head>
  ...
  <title>Data Pengguna : LAYAR</title>
...
@endif
                              ...
                              <table id="example1" class="table table-bordered table-striped">
                                <thead class="table-white align-items-center">
                                  ...
                                  <tr>
                                    ...
                                    <th width="300px" scope="col">Nama Pengguna</th>
                                    <th width="200px" scope="col">Jabatan</th>
                                    <th width="250px" scope="col">Alamat</th>
                                    <th width="250px" scope="col">Foto Profil</th>
  ...
  @endphp
                                  ...
                                  <tr>
                                    <th class="number" scope="row">{{ $user->id }}</th>
                                    <td>{{ $user->nama_lengkap }}</td>
                                    <td>
                                      @if ($user->kode_status === 1111)
                                          Ketua RT
                                      @elseif ($user->kode_status === 3333)
                                          Warga
                                      @else
                                          Unknown User
                                      @endif
                                    ...
                                    <td>
                                    @if(Auth::user()->foto_profil)
                            <img src="{{ asset ('foto/'.Auth::user()->foto_profil)}}" alt="Profile" class="rounded-circle" width="40" height="40">
                        @else
                            <img src="{{ asset('dashboard_asset/assets/img/no-profile-user.png') }}" alt="Unknown Profile" class="rounded-circle" width="40" height="40">
                        @endif
                                    ...
                                    <a href="#" type="button" class="btn btn-secondary delete" data-id="{{ $user->id }}" data-nama="{{ $user->nama_lengkap }}">Hapus</button></a>
