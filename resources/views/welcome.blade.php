...
<body>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('foto/' . $row->foto) }}" class="testimonial-img" alt="" width="466" height="328">
                                    <h3>{{$row->nama_agenda}}</h3>
                                </div>
                                <p>
                                    {{ \Carbon\Carbon::parse($row->tgl_kegiatan)->locale('id')->isoFormat('dddd, DD-MM-YYYY') }} di {{ ucfirst($row->lokasi) }}
                                </p>
    ...
    <footer id="footer" class="footer">
        ...
        <footer id="footer" class="footer">
            ...
            <div class="container">
                <div class="copyright">
                    2023 &copy; Designed and Developed by <strong><span>Tim Layar</span></strong>.
                </div>
            </div>
        </footer><!-- End Footer -->
